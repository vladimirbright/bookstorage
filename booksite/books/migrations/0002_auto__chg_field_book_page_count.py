...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.page_count'
        db.alter_column('books_book', 'page_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Book.page_count'
        db.alter_column('books_book', 'page_count', self.gf('django.db.models.fields.PositiveIntegerField')())
