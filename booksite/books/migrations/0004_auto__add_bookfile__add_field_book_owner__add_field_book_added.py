...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('books_book', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']), keep_default=False)

        # Adding field 'Book.added'
        db.add_column('books_book', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 9, 25, 23, 49, 38, 553178), blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('books_book', 'added')
